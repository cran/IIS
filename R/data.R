...
"traffic_accidents"
utils::globalVariables("traffic_accidents")

engineering_drawing_hours <- NULL
...
utils::globalVariables("engineering_drawing_hours")

interstitial_lengths <- NULL
...
utils::globalVariables("interstitial_lengths")

state_poverty_levels_2013 <- NULL
...
utils::globalVariables("state_poverty_levels_2013")

american_league_salary_2014 <- NULL
...
utils::globalVariables("american_league_salary_2014")

national_league_salary_2014 <- NULL
...
utils::globalVariables("national_league_salary_2014")

motor_vehicle_death_rate_2012 <- NULL
...
utils::globalVariables("motor_vehicle_death_rate_2012")


# Chapter 2

weekly_salaries <- NULL
...
"weekly_salaries"
utils::globalVariables("weekly_salaries")
...
#' summary(pines_1997)
"pines_1997"
utils::globalVariables("pines_1997")
...
#' summary(emissions)
"emissions"
utils::globalVariables("emissions")

chargeoff_rates <- NULL
...
"chargeoff_rates"
utils::globalVariables("chargeoff_rates")

delinquency_rates <- NULL
...
"delinquency_rates"
utils::globalVariables("delinquency_rates")

agricultural_chargeoff_rates_by_quarter <- NULL
...
utils::globalVariables("agricultural_chargeoff_rates_by_quarter")

q2_q4_agricultural_chargeoff_rates <- NULL
...
utils::globalVariables("q2_q4_agricultural_chargeoff_rates")
...
#' summary(tiaa_cref)
"tiaa_cref"
utils::globalVariables("tiaa_cref")

kentucky_derby_2012 <- NULL
...
"kentucky_derby_2012"
utils::globalVariables("kentucky_derby_2012")

airline_arrivals <- NULL
...
"airline_arrivals"
utils::globalVariables("airline_arrivals")

mother_smoking_education <- NULL
...
utils::globalVariables("mother_smoking_education")

mother_smoking_education_2010 <- NULL
...
utils::globalVariables("mother_smoking_education_2010")

mother_smoking_age <- NULL
...
"mother_smoking_age"
utils::globalVariables("mother_smoking_age")

mother_smoking_education_1989_1993 <- NULL
...
utils::globalVariables("mother_smoking_education_1989_1993")
...
#' summary(state_cdi)
"state_cdi"
utils::globalVariables("state_cdi")

pew_science_survey_data_by_party <- NULL
...
utils::globalVariables("pew_science_survey_data_by_party")

pew_science_survey_data_by_age_group <- NULL
...
utils::globalVariables("pew_science_survey_data_by_age_group")

college_rankings_2012 <- NULL
...
utils::globalVariables("college_rankings_2012")

population_estimates_2015 <- NULL
...
utils::globalVariables("population_estimates_2015")
...
#' @source \url{https://www.nba.com/stats/teams/traditional?Season=2015-16}
#' @examples
#' data(nba_2015_2016)
#' summary(nba_2015_2016)
"nba_2015_2016"
utils::globalVariables("nba_2015_2016")


# Chapter 3

osu_math_salaries_2015 <- NULL
...
utils::globalVariables("osu_math_salaries_2015")

school_report_cards_2014 <- NULL
...
utils::globalVariables("school_report_cards_2014")

reading_habits_2011 <- NULL
...
"reading_habits_2011"
utils::globalVariables("reading_habits_2011")
...
#' summary(pennies_age)
"pennies_age"
utils::globalVariables("pennies_age")
...
#' summary(beer_head)
"beer_head"
utils::globalVariables("beer_head")

body_temperature_and_heart_rate <- NULL
...
utils::globalVariables("body_temperature_and_heart_rate")
...
#' summary(movie_facts)
"movie_facts"
utils::globalVariables("movie_facts")

weight_of_Euros <- NULL
...
"weight_of_Euros"
utils::globalVariables("weight_of_Euros")
...
"homes_prices"
utils::globalVariables("homes_prices")


# Chapter 6

presidential_election_polls <- NULL
...
utils::globalVariables("presidential_election_polls")


# Chapter 7 

average_HDL_levels <- NULL
...
"average_HDL_levels"
utils::globalVariables("average_HDL_levels")
...
"pmn_migration"
utils::globalVariables("pmn_migration")

female_amerindians <- NULL
...
"female_amerindians"
utils::globalVariables("female_amerindians")

diamonds_carats_color_cost <- NULL
...
utils::globalVariables("diamonds_carats_color_cost")

house_lot_sizes <- NULL
...
"house_lot_sizes"
utils::globalVariables("house_lot_sizes")


# Chapter 8 

percentage_hatched_eggs <- NULL
...
utils::globalVariables("percentage_hatched_eggs")
...
"desimipramine"
utils::globalVariables("desimipramine")


# Chapter 9 

arion_subfuscus <- NULL
...
"arion_subfuscus"
utils::globalVariables("arion_subfuscus")

goggled_green_turtles <- NULL
...
utils::globalVariables("goggled_green_turtles")
...
"infant_walking"
utils::globalVariables("infant_walking")
...
"gender_roles"
utils::globalVariables("gender_roles")

health_care_by_affiliation <- NULL
...
utils::globalVariables("health_care_by_affiliation")
...
"sheep_weight"
utils::globalVariables("sheep_weight")


# Chapter 12

meniscal_repairs_load_at_failure <- NULL
...
utils::globalVariables("meniscal_repairs_load_at_failure")

proportion_for_profit_hospitals <- NULL
...
utils::globalVariables("proportion_for_profit_hospitals")

fmr_white_tailed_deer <- NULL
...
utils::globalVariables("fmr_white_tailed_deer")
